...
# Title: dibit_mapper_example
# Generated: Mon Oct 30 19:12:44 2017
##################################################
...
class dibit_mapper_example(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=dibit_mapper_example, options=None):
